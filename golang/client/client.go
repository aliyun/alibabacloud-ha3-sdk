 ...
 * 系统提供了丰富的搜索语法以满足用户各种场景下的搜索需求。
 */
func (client *Client) SearchBytesEx (request *SearchRequestModel, runtime *util.RuntimeOptions) (_result *SearchBytesResponseModel, _err error) {
  _result = &SearchBytesResponseModel{}
  _body, _err := client._request_search_bytes(tea.String("GET"), tea.String("/query"), tea.ToMap(request.Query), request.Headers, nil, runtime)
  if _err != nil {
    return _result, _err
  }
  _err = tea.Convert(_body, &_result)
...
func (client *Client) SearchBytes (request *SearchRequestModel) (_result *SearchBytesResponseModel, _err error) {
  ...
  _result = &SearchBytesResponseModel{}
  _body, _err := client.SearchBytesWithOptions(request, runtime)
  if _err != nil {
    return _result, _err
  }
  _result = _body
 ...
 * 系统提供了丰富的搜索语法以满足用户各种场景下的搜索需求,及传入运行时参数.
 */
func (client *Client) SearchBytesWithOptions (request *SearchRequestModel, runtime *util.RuntimeOptions) (_result *SearchBytesResponseModel, _err error) {
  _result = &SearchBytesResponseModel{}
  _body, _err := client.SearchBytesEx(request, runtime)
  if _err != nil {
    return _result, _err
  }
  _result = _body
