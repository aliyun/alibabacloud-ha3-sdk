...
public class CreateTableRequest extends TeaModel {
    ...
    /**
     * <p>Specifies whether to perform only a dry run, without performing the actual request. The system only checks the validity of the data source. Valid values:true,false</p>
     * 
     * <strong>example:</strong>
     * <p>true</p>
     */
    ...
    public static class CreateTableRequestDataSourceConfig extends TeaModel {
        ...
        public CreateTableRequestDataSourceConfig setCatalog(String catalog) {
        ...
        public CreateTableRequestDataSourceConfig setDatabase(String database) {
