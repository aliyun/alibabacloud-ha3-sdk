...
namespace Models
{
  ...
  public:
    ...
    inline const vector<ListTablesResponseBodyResult> & result() const { DARABONBA_PTR_GET_CONST(result_, vector<ListTablesResponseBodyResult>) };
    inline vector<ListTablesResponseBodyResult> result() { DARABONBA_PTR_GET(result_, vector<ListTablesResponseBodyResult>) };
    inline ListTablesResponseBody& setResult(const vector<ListTablesResponseBodyResult> & result) { DARABONBA_PTR_SET_VALUE(result_, result) };
    inline ListTablesResponseBody& setResult(vector<ListTablesResponseBodyResult> && result) { DARABONBA_PTR_SET_RVALUE(result_, result) };
  ...
  protected:
    ...
    // The result.
    std::shared_ptr<vector<ListTablesResponseBodyResult>> result_ = nullptr;
  };
