...
#ifndef ALIBABACLOUD_MODELS_CREATETABLEREQUESTVECTORINDEXADVANCEPARAMS_HPP_
#define ALIBABACLOUD_MODELS_CREATETABLEREQUESTVECTORINDEXADVANCEPARAMS_HPP_
...
namespace Models
{
  ...
  public:
    friend void to_json(Darabonba::Json& j, const CreateTableRequestVectorIndexAdvanceParams& obj) { 
    ...
    friend void from_json(const Darabonba::Json& j, CreateTableRequestVectorIndexAdvanceParams& obj) { 
    ...
    CreateTableRequestVectorIndexAdvanceParams() = default ;
    CreateTableRequestVectorIndexAdvanceParams(const CreateTableRequestVectorIndexAdvanceParams &) = default ;
    CreateTableRequestVectorIndexAdvanceParams(CreateTableRequestVectorIndexAdvanceParams &&) = default ;
    CreateTableRequestVectorIndexAdvanceParams(const Darabonba::Json & obj) { from_json(obj, *this); };
    virtual ~CreateTableRequestVectorIndexAdvanceParams() = default ;
    CreateTableRequestVectorIndexAdvanceParams& operator=(const CreateTableRequestVectorIndexAdvanceParams &) = default ;
    CreateTableRequestVectorIndexAdvanceParams& operator=(CreateTableRequestVectorIndexAdvanceParams &&) = default ;
    ...
    inline CreateTableRequestVectorIndexAdvanceParams& setBuildIndexParams(string buildIndexParams) { DARABONBA_PTR_SET_VALUE(buildIndexParams_, buildIndexParams) };
    ...
    inline CreateTableRequestVectorIndexAdvanceParams& setLinearBuildThreshold(string linearBuildThreshold) { DARABONBA_PTR_SET_VALUE(linearBuildThreshold_, linearBuildThreshold) };
    ...
    inline CreateTableRequestVectorIndexAdvanceParams& setMinScanDocCnt(string minScanDocCnt) { DARABONBA_PTR_SET_VALUE(minScanDocCnt_, minScanDocCnt) };
    ...
    inline CreateTableRequestVectorIndexAdvanceParams& setSearchIndexParams(string searchIndexParams) { DARABONBA_PTR_SET_VALUE(searchIndexParams_, searchIndexParams) };
