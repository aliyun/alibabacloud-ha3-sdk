...
namespace Models
{
  ...
  public:
    ...
    inline DeleteTableResponseBody& setResult(const Darabonba::Json & result) { DARABONBA_SET_VALUE(result_, result) };
    inline DeleteTableResponseBody& setResult(Darabonba::Json & result) { DARABONBA_SET_RVALUE(result_, result) };
