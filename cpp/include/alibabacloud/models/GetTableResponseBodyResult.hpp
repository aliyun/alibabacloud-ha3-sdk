...
namespace Models
{
  ...
  public:
    ...
    virtual bool empty() const override { this->name_ != nullptr
        && this->partitionCount_ != nullptr && this->primaryKey_ != nullptr && this->rawSchema_ != nullptr && this->dataProcessorCount_ != nullptr && this->fieldSchema_ != nullptr
        && this->status_ != nullptr && this->vectorIndex_ != nullptr && this->dataSource_ != nullptr && this->dataProcessConfig_ != nullptr; };
